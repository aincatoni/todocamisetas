...
class CamisetaController extends Controller
{
    ...
    public function index(Request $request): JsonResponse
    {
        try {
            ...
            return $this->serverErrorResponse($exception, 'No fue posible listar las camisetas.');
        }
    }
    ...
    public function show(Request $request, string $id): JsonResponse
    {
        try {
            ...
            return $this->serverErrorResponse($exception, 'No fue posible obtener la camiseta.');
        }
    }
    ...
    public function update(Request $request, string $id): JsonResponse
    {
        try {
            ...
            return $this->serverErrorResponse($exception, 'No fue posible actualizar la camiseta.');
        }
    }
    ...
    public function destroy(string $id): JsonResponse
    {
        try {
            ...
            return $this->serverErrorResponse($exception, 'No fue posible eliminar la camiseta.');
        }
    }
